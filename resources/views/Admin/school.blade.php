            ...
            <div class="col-sm">
                <div class="card dark">
                    <div class="card-head d-flex justify-content-center">
                        <img class="card-img" src="{{ asset('storage/uploads/' . $school->user_id . '.png') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="container dark light">
                                            @isset($school->location)
                                                <a href="{{ $school->location }}" target="_blank"><label
                                                        class="fa fa-map-marker dark light"></label></a>
                                            @endisset
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="container dark light">
                                            @isset($school->whatsapp)
                                                <a href="{{ $school->whatsapp }}" target="_blank"><label
                                                        class="fab fa-whatsapp dark light"></label></a>
                                            @endisset
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="container dark light">
                                            @isset($school->instagram)
                                                <a href="{{ $school->instagram }}" target="_blank"><label
                                                        class="fab fa-instagram dark light"></label></a>
                                            @endisset
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="container dark light">
                                            @isset($school->youtube)
                                                <a href="{{ $school->youtube }}" target="_blank"><label
                                                        class="fab fa-youtube dark light"></label></a>
                                            @endisset
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <div class="col-sm">
                <div class="card" style="width: 18rem;">
                    <ul class="list-group  list-group-flush">
                        ...
                        <li class="list-group-item  dark light"><span class="fa fa-book-reader">&nbsp;Students</span><br>
                            {{ $studentscount }}
                        </li>
                    </ul>
                </div>
