...
<head>
    ...
    <link id="logo_icon" rel="icon" href="{{ asset('img/badion.png') }}" {{-- onerror="this.onerror=null;this.href='{{ asset('img/badion.png') }}'" --}}>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('thome') }}">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tstudent') }}">Students</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tstudymaterials') }}">Studymaterial</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('thomework') }}">Homework</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('studentattendence') }}">Attendance</a>
                    </li>
                    {{-- <li class="nav-item">
            <a class="nav-link" href="fee">Fees</a>
          </li> --}}
                    {{-- <li class="nav-item">
                        <a class="nav-link" href="{{route('ttimetable')}}" target="_blank">TimeTable</a>
                    </li> --}}
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tnoticeboard') }}">Notice Board</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tlogout') }}"><i class="fa fa-sign-out-alt"></i></a>
                    </li>
                    <li class="nav-item">
            ...
            <nav style="padding: 0px 50px;">
                <a class="nav-link fa fa-user" href="{{ route('tprofile') }}"></a>
            </nav>
        </div>
    </nav>
