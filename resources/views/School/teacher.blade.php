            ...
            <div class="col-sm">
                <div class="card" style="width: 18rem;">
                    <ul class="list-group  list-group-flush">
                        <b>
                            <li class="list-group-item  dark light">About</li>
                        </b>
                        @isset($subject[0])
                            <li class="list-group-item  dark light">
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            <td class="container dark light"><span class="fa fa-book">&nbsp;Subjects</span>
                                            </td>
                                            <td class="container dark light"><span class="fa fa-school">&nbsp;Class</span>
                                            </td>
                                        </tr>
                                        @foreach ($subject as $sub)
                                            <tr>
                                                <td class="container dark light">{{ $sub->subject }}</td>
                                                <td class="container dark light">{{ $sub->class }}({{ $sub->div }})
                                                </td>
                                            </tr>
                                        @endforeach
                                    </table>
