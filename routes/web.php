...
Route::group(["middleware" => "guest:web"], function () {
    ...
    Route::post('addschool', [SmsController::class, 'addschool'])->name("addschool");
...
Route::group(["prefix" => "School", "middleware" => ["auth:web", "isSchool"]], function () {
    ...
    Route::post('addschoollogo', [SchoolDetailsController::class, 'addschoollogo'])->name("addschoollogo");
